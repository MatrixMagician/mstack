...
**Plugin name:** `mstack`
**Upstream:** `github.com/cursor/plugins` — `pstack/` (v0.14.1, synced to `b0b9c7a`, v0.15.4) plus three skills from `cursor-team-kit/`
...
| Version | 0.14.1, later synced to `b0b9c7a` | Reset to `0.1.0`; the port is a new lineage |
