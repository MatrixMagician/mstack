...
If a phase creates or edits a skill, the phase instructs the implementer to use Claude Code's `skill-creator` skill for authoring SKILL.md files.
...
- Browser / Electron / Web UIs: the `control-ui` skill.
- CLIs and TUIs: the `control-cli` skill.
