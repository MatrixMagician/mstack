...
The panel defaults to one seat per tier (`fable`, `opus`, `sonnet`) and you can adjust it per task or in `.claude/rules/mstack-models.md`. Ask for more candidates when the decision matters, fewer when it doesn't:
