...
Short works because the session-start hook keeps the mode in force and the playbook holds the structure. Your words carry the intent, and the skill carries the rigor.
